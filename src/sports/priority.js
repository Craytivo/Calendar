...
function isUniversalMajorGame(game) { return isPlayoffOrPostseason(game) || isChampionship(game) || isEliminationGame(game) || hasMeaningfulImplications(game) || isMarchMadnessSweetSixteenOrLater(game) || game.isMajorEvent === true; }
