...
import { getExcitementScore, getWatchLevel, getWatchScore, getWatchReasons } from './watchability.js';
...
assert.ok(!getWatchReasons({ ...base, homeScore: 0, awayScore: 0 }).includes('Tied game'));
assert.ok(getWatchReasons({ ...base, status: 'live', homeScore: 0, awayScore: 0 }).includes('Tied game'));
